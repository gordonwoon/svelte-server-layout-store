...
<main>
	...
	<p>
		<em
			>This page demonstrates using a store (<code>userDetailStore</code>) populated automatically
			by the root layout based on data loaded in this page's <code>+page.server.ts</code>.</em
		>
	</p>
</main>
